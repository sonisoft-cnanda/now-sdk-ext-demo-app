...
Record({
    $id: Now.ID['e745f69983e37210fdb8f7b6feaad359'],
    table: 'sys_hub_flow',
    data: {
        access: 'public',
        acls: '',
        ...
        internal_name: 'it_copy_verify_1773111896707',
        label_cache:
        ...
        name: 'IT Copy Verify 1773111896707',
        pre_compiled: false,
        run_as: 'user',
        run_with_roles: '',
        sc_callable: false,
        ...
        type: 'flow',
        version: '2',
        version_record: '77453a9983e37210fdb8f7b6feaad306',
    },
})
Record({
    $id: Now.ID['2b45f69983e37210fdb8f7b6feaad399'],
    table: 'sys_hub_trigger_instance_v2',
    data: {
        flow: 'e745f69983e37210fdb8f7b6feaad359',
        name: 'Created',
...
Record({
    $id: Now.ID['af45f69983e37210fdb8f7b6feaad396'],
...
Record({
    $id: Now.ID['ef45f69983e37210fdb8f7b6feaad394'],
    table: 'sys_hub_action_instance_v2',
    data: {
...
Record({
    $id: Now.ID['2345f69983e37210fdb8f7b6feaad35a'],
    table: 'sys_flow_cat_variable_model',
    data: {
        id: 'e745f69983e37210fdb8f7b6feaad359',
        name: 'IT Copy Verify 1773111896707',
    },
})
Record({
    $id: Now.ID['2345f69983e37210fdb8f7b6feaad382'],
	...
	return '';  // return the calculated value
        ...
        mandatory: 'false',
        max_length: '200',
        model: 'e745f69983e37210fdb8f7b6feaad359',
        model_id: 'e745f69983e37210fdb8f7b6feaad359',
        model_table: 'sys_hub_flow',
        name: 'var__m_sys_hub_flow_input_e745f69983e37210fdb8f7b6feaad359',
        order: '101',
        primary: 'false',
        read_only: 'false',
...
Record({
    $id: Now.ID['2f45f69983e37210fdb8f7b6feaad363'],
    table: 'sys_hub_flow_input',
    data: {
        active: 'true',
        array: 'false',
