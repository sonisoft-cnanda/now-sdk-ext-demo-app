...
Record({
    $id: Now.ID['887dda5583237210fdb8f7b6feaad32c'],
    table: 'sys_hub_flow',
    data: {
        access: 'public',
        acls: '',
        ...
        internal_name: 'copy_of_change__standard',
        label_cache:
        ...
        type: 'flow',
        version: '2',
        version_record: '6c7d1e5583237210fdb8f7b6feaad30e',
    },
})
Record({
    $id: Now.ID['107dda5583237210fdb8f7b6feaad396'],
    table: 'sys_hub_trigger_instance_v2',
    data: {
        flow: '887dda5583237210fdb8f7b6feaad32c',
        name: 'Created',
...
Record({
    $id: Now.ID['107dda5583237210fdb8f7b6feaad390'],
...
Record({
    $id: Now.ID['147dda5583237210fdb8f7b6feaad393'],
    table: 'sys_hub_action_instance_v2',
    data: {
...
Record({
    $id: Now.ID['807dda5583237210fdb8f7b6feaad332'],
    table: 'sys_flow_cat_variable_model',
    data: {
        id: '887dda5583237210fdb8f7b6feaad32c',
        name: 'Copy of Change - Standard',
    },
})
Record({
    $id: Now.ID['047dda5583237210fdb8f7b6feaad33f'],
	...
	return '';  // return the calculated value
        ...
        mandatory: 'true',
        max_length: '200',
        model: '887dda5583237210fdb8f7b6feaad32c',
        model_id: '887dda5583237210fdb8f7b6feaad32c',
        model_table: 'sys_hub_flow',
        name: 'var__m_sys_hub_flow_input_887dda5583237210fdb8f7b6feaad32c',
        order: '100',
        primary: 'false',
        read_only: 'false',
...
Record({
    $id: Now.ID['5c7dda5583237210fdb8f7b6feaad357'],
    table: 'sys_hub_flow_input',
    data: {
        active: 'true',
        array: 'false',
