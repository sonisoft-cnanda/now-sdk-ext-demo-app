...
Record({
    $id: Now.ID['8b45b69983e37210fdb8f7b6feaad3ab'],
    table: 'sys_hub_flow',
    data: {
        access: 'public',
        acls: '',
        ...
        internal_name: 'it_copy_1773111895257',
        label_cache:
...
Record({
    $id: Now.ID['9345b69983e37210fdb8f7b6feaad3ef'],
    table: 'sys_hub_trigger_instance_v2',
    data: {
        flow: '8b45b69983e37210fdb8f7b6feaad3ab',
        name: 'Created',
...
Record({
    $id: Now.ID['1b45b69983e37210fdb8f7b6feaad3ec'],
...
Record({
    $id: Now.ID['5b45b69983e37210fdb8f7b6feaad3ea'],
    table: 'sys_hub_action_instance_v2',
    data: {
...
Record({
    $id: Now.ID['c345b69983e37210fdb8f7b6feaad3ad'],
    table: 'sys_flow_cat_variable_model',
    data: {
        id: '8b45b69983e37210fdb8f7b6feaad3ab',
        name: 'IT Copy 1773111895257',
    },
})
Record({
    $id: Now.ID['4345b69983e37210fdb8f7b6feaad3c5'],
	...
	return '';  // return the calculated value
        ...
        mandatory: 'true',
        max_length: '200',
        model: '8b45b69983e37210fdb8f7b6feaad3ab',
        model_id: '8b45b69983e37210fdb8f7b6feaad3ab',
        model_table: 'sys_hub_flow',
        name: 'var__m_sys_hub_flow_input_8b45b69983e37210fdb8f7b6feaad3ab',
        order: '100',
        primary: 'false',
        read_only: 'false',
...
Record({
    $id: Now.ID['c745b69983e37210fdb8f7b6feaad3ca'],
    table: 'sys_hub_flow_input',
    data: {
        active: 'true',
        array: 'false',
